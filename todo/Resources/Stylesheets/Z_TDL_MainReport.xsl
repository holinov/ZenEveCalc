...
<!-- Modified by JAZ, April 12 2010, then again AprilMay 2012 -->
<!--  V3 Sept 2012-->
...
<!-- This stylesheet includes: Priority, Taskname, Start date, Due date, Progress, Assigned to as a default
            ...
            Have included the possibility to add flagged status, category, status & comments next to the task title.
               ...
               Note, flagged status isn't very sexy - just "!!" at the start of the task name
...
<!--  Intended improvements not achieved
	...
	Ideally dont have listview bolded, but still have top task bolded in treeview (I think they are bolded as in that view, tasks have no descendents
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	Note Values of 0 or 1, give one person.  Values of 2 or 3 give 2 or 3 people repectively.  Values above 3 give no more than 3 people-->  
...
<!--		<xsl:call-template name="get_cat"/> -->
	...
	<!-- 45 - @Category as category of the task -->	
...
<!-- Ideally this code should work instead of the string manipulation code below -->
