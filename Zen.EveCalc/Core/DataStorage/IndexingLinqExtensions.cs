...
namespace Zen.EveCalc.Core.DataStorage
{
    ...
    public static class IndexingLinqExtensions
    {
        ...
        /// </summary>
        public static IEnumerable<TResult> WhereEntityIs<TResult>(this IEnumerable<object> queryable,
                                                                  params string[] names)
        {
        ...
        public static IEnumerable<TResult> Hierarchy<TContainer, TResult>(this TContainer item, string path)
        {
            throw new NotSupportedException("This method is provided solely to allow query translation on the server");
        }

        public static IEnumerable<TResult> Hierarchy<TContainer, TResult>(this TContainer item,
                                                                          Func<TContainer, IEnumerable<TResult>> path)
        {
            throw new NotSupportedException("This method is provided solely to allow query translation on the server");
        }
    }
